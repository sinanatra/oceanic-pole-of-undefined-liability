<article>
    ...
    <p>
        ...
        the Earth's marine environment.
    </p>
    <p>
        While space debris is mainly associated with the countless pieces
    ...
    <h2>Map</h2>
    <p>
        A timeline visualising all the artificial space objects that fell within
    ...
    <p>
        By geolocating their predicted reentry, the resulting coordinates are
        juxtaposed with the legal limits of coastal states‘ sovereign rights,
        spanning from Exclusive Economic Zones to Navigational Areas.
    </p>

    <p>
        While the first shows the conflicting intersection with the UN Law of
